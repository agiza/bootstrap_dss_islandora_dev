  ...
  <div class="navbar-inner">
   ...
   <div class="auth-share-container container">
     ...
     <div class="auth-container modal-container container">
	  ...
	  <div class="auth-icon"><span class="button-auth-icon"><object data="/sites/all/themes/bootstrap_dss_islandora_dev/files/UserIcon.svg" type="image/svg+xml"></object></span></div>
     ...
     <div class="share-container modal-container container">
       ...
       <div id="share-control-container" class="modal-control-container container">
         ...
         <div class="share-icon"><span class="button-auth-icon"><object data="/sites/all/themes/bootstrap_dss_islandora_dev/files/ShareIcon.svg" type="image/svg+xml"></object></span></div>
